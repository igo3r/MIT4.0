...
public class OrchestrationFlags extends HashMap<String,Boolean> {
	...
	private static Map<String,Flag> initFlagMap() {
		...
		result.put(CommonConstants.ORCHESTRATON_FLAG_MATCHMAKING, Flag.MATCHMAKING);
		result.put(CommonConstants.ORCHESTRATON_FLAG_METADATA_SEARCH, Flag.METADATA_SEARCH);
	...
	public enum Flag {
		...
		MATCHMAKING(CommonConstants.ORCHESTRATON_FLAG_MATCHMAKING),
		METADATA_SEARCH(CommonConstants.ORCHESTRATON_FLAG_METADATA_SEARCH),
