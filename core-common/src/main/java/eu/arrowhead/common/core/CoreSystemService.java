...
public enum CoreSystemService {
	...
	CONSUMER_TEMPERATURE_ARRAY_SINGLE_SERVICE(MITConstants.MIT_SERVICE_TEMPERATURE_ARRAY_SINGLE, MITConstants.MIT_CONSUMER_URI + MITConstants.MIT_CONSUMER_TEMPERATURE_ARRAY_SINGLE_URI),
	PRODUCER_GET_STATUS_SERVICE(MITConstants.MIT_PRODUCER_SERVICE_GET_STATUS, MITConstants.MIT_PRODUCER_URI + MITConstants.MIT_PRODUCER_GET_STATUS_URI);
