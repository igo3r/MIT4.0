...
5. Create Empty Arrowhead Database
   ...
   3. Copy content from file [*create_empty_arrowhead_db.sql*](https://github.com/igo3r/MIT4.0/blob/UseCase3/scripts/create_empty_arrowhead_db.sql)
...
9. After all systems are started successfully go back to script folder. 
   1. Copy content from file [*database_dependencies.sql*](https://github.com/igo3r/MIT4.0/blob/UseCase3/scripts/database_dependencies.sql)
...
[application.properties File C0](https://github.com/igo3r/MIT4.0/blob/UseCase3/arrowhead-client/src/main/resources/application.properties): 
...
[application.properties File C1](https://github.com/igo3r/MIT4.0/blob/UseCase3/arrowhead-consumer/src/main/resources/application.properties):  
...
[application.properties File C2](https://github.com/igo3r/MIT4.0/blob/UseCase3/arrowhead-producer/src/main/resources/application.properties): 
...
To use Swagger the class [**AuthSwaggerConfig.java**](https://github.com/igo3r/MIT4.0/blob/UseCase3/arrowhead-consumer/src/main/java/eu/arrowhead/mit/swagger/AuthSwaggerConfig.java)  in the package *eu.arrowhead.mit.swagger* is required. Therefore the *MITConstants.MIT_SYSTEM_CONSUMER* must be used. 
...
To use Swagger the class [**AuthSwaggerConfig.java**](https://github.com/igo3r/MIT4.0/blob/UseCase3/arrowhead-producer/src/main/java/eu/arrowhead/mit/swagger/AuthSwaggerConfig.java)  in the package *eu.arrowhead.mit.swagger* is required. Therefore the *MITConstants.MIT_SYSTEM_PRODUCER* must be used. 
...
To use Swagger the class [**AuthSwaggerConfig.java**](https://github.com/igo3r/MIT4.0/blob/UseCase3/arrowhead-client/src/main/java/eu/arrowhead/mit/swagger/AuthSwaggerConfig.java) in the package *eu.arrowhead.mit.swagger* is required. Therefore the *MITConstants.MIT_SYSTEM_PRODUCER* must be used. 
```
@EnableSwagger2
@Configuration
public class AuthSwaggerConfig extends DefaultSwaggerConfig {
...
Go to [*arrowhead-core-common/src/main/java/eu/arrowhead/common/core/CoreSystemService.java*](https://github.com/igo3r/MIT4.0/blob/UseCase3/core-common/src/main/java/eu/arrowhead/common/core/CoreSystemService.java) and add following lines after **ORCHESTRATION_SERVICE*** (Line 21):
...
Go to [*arrowhead-core-common/src/main/java/eu/arrowhead/common/core/CoreSystem.java*](https://github.com/igo3r/MIT4.0/blob/UseCase3/core-common/src/main/java/eu/arrowhead/common/core/CoreSystem.java) and add following lines at the beginning before SERVICE_REGISTRY:
